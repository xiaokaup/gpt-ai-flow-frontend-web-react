...
interface IProModePage_Background_input {
  ...
  setBackground: Dispatch<SetStateAction<IBackground_for_type_langchain>>;
}
export const ProModePage_Background = (props: IProModePage_Background_input) => {
  const { t, backgroundSelected: selectedBackgroundFormInfo, background, setBackground } = props;
      ...
      {isShow && (
        <div className="row">
          <Form form={form} initialValues={background}>
            {selectedBackgroundFormInfo.formItems.map((item: IFormItem<IBackground_for_type_langchain>) => {
              const {
                componentType,
                label,
                name,
