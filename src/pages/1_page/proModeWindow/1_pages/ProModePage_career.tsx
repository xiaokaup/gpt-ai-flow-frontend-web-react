...
export const ProModePage_career = (props: IProModePage_career_input) => {
  ...
  const proModeData = PROMODE_DATA as IProMode_v2_oneProMode<EProMode_v2_careerManager_contextType>;
  const defaultContextType = DEFAULT_CONTEXT_TYPE as EProMode_v2_careerManager_contextType;
  ...
  const [contextType, setContextType] = useState<EProMode_v2_careerManager_contextType>(defaultContextType);
  ...
  const handleContextTypeChange = (paraContextPromptType: EProMode_v2_careerManager_contextType) => {
        ...
        <div className="column" style={{ display: 'flex', alignItems: 'center' }}>
          ...
          <Select
            ...
            options={defaultContextTypesForSelect.map((item) => {
              return {
                label: contextPrompts[item as EProMode_v2_careerManager_contextType].name,
                value: item,
              };
            })}
          />{' '}
