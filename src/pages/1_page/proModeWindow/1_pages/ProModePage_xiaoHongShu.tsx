...
export const ProModePage_xiaoHongShu = (props: IProModePage_xiaoHongShu_input) => {
  ...
  const proModeData = PROMODE_DATA as IProMode_v2_oneProMode<EProMode_v2_xiaoHongShuManager_contextType>;
  const defaultContextType = DEFAULT_CONTEXT_TYPE as EProMode_v2_xiaoHongShuManager_contextType;
  ...
  const [contextType, setContextType] = useState<EProMode_v2_xiaoHongShuManager_contextType>(defaultContextType);
  ...
  const handleContextTypeChange = (paraContextPromptType: EProMode_v2_xiaoHongShuManager_contextType) => {
        ...
        <div className="column" style={{ display: 'flex', alignItems: 'center' }}>
          ...
          <Select
            ...
            options={defaultContextTypesForSelect.map((item) => {
              return {
                label: contextPrompts[item as EProMode_v2_xiaoHongShuManager_contextType].name,
                value: item,
              };
            })}
          />{' '}
