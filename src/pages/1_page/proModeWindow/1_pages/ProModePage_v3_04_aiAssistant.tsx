...
export const ProModePage_v3_04_aiAssistant = (props: IProModePage_copyWriting_input) => {
  ...
  const handleContextTypeChange = (paraContextType: EProMode_v3_04_aiAssistant_contextType) => {
    ...
    if (!contextPrompts[paraContextType].stages[contextTypeStage].value) {
      handleContextTypeStageChange(EProMode_v3_04_aiAssistant_contextTypeStage.DEFAULT);
    }
  ...
  const handleContextTypeStageChange = (paraContextTypeStage: EProMode_v3_04_aiAssistant_contextTypeStage) => {
          ...
          <div className="column" style={{ display: 'flex', alignItems: 'center' }}>
            ...
            <Select
              ...
              options={defaultContextTypeStagesForSelect
                .map((item) => {
                  return {
                    label: contextPrompts[contextType].stages[item as EProMode_v3_04_aiAssistant_contextTypeStage].name,
                    value: item,
                    disabled:
                      contextPrompts[contextType].stages[item as EProMode_v3_04_aiAssistant_contextTypeStage].disable,
                  };
                })
          ...
          <div className="column" style={{ display: 'flex', alignItems: 'center' }}>
            ...
            <Select
              ...
              options={defaultContextTypesForSelect
                .map((item) => {
                  return {
                    label: contextPrompts[item as EProMode_v3_04_aiAssistant_contextType].name,
                    value: item,
                    disabled: contextPrompts[item as EProMode_v3_04_aiAssistant_contextType].disable,
                  };
                })
                .filter((item) => !item.disabled || item.label)}
            />
