...
export const ProModePage_v3_06_careerManager = (props: IProModePage_career_input) => {
  ...
  const handleContextTypeChange = (paraContextType: EProMode_v3_06_careerManager_contextType) => {
    ...
    if (!contextPrompts[paraContextType].stages[contextTypeStage].value) {
      handleContextTypeStageChange(EProMode_v3_06_careerManager_contextTypeStage.DEFAULT);
    }
            ...
            <Select
              ...
              options={defaultContextTypeStagesForSelect
                .map((item) => {
                  return {
                    label:
                      contextPrompts[contextType].stages[item as EProMode_v3_06_careerManager_contextTypeStage].name,
                    value: item,
                    disabled:
                      contextPrompts[contextType].stages[item as EProMode_v3_06_careerManager_contextTypeStage].disable,
                  };
                })
              ...
              options={defaultContextTypesForSelect
                .map((item) => {
                  return {
                    ...
                    value: item,
                    disabled: contextPrompts[item as EProMode_v3_06_careerManager_contextType].disable,
                  };
                })
                .filter((item) => !item.disabled || item.label)}
            />
