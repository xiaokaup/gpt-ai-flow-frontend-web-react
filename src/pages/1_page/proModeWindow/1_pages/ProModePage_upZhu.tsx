...
export const ProModePage_v3_07_upZhu = (props: IProModePage_copyWriting_input) => {
  ...
  const handleContextTypeChange = (paraContextType: EProMode_v3_07_upZhu_contextType) => {
  ...
  const handleContextTypeStageChange = (paraContextTypeStage: EProMode_v3_07_upZhu_contextTypeStage) => {
