...
interface IProModePage_copyWriting_input {
  ...
  defaultContextPromptType: EProMode_v2_upZhu_contextType;
...
export const ProModePage_upZhu = (props: IProModePage_copyWriting_input) => {
  ...
  const [contextPromptType, setContextPromptType] = useState<EProMode_v2_upZhu_contextType>(defaultContextPromptType);
  ...
  const handleContextTypeChange = (paraContextPromptType: EProMode_v2_upZhu_contextType) => {
