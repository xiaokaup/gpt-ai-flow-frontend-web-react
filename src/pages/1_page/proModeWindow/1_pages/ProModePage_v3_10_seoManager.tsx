...
export const ProModePage_v3_10_seoManager = (props: IProModePage_copyWriting_input) => {
  ...
  const handleContextTypeChange = (paraContextType: EProMode_v3_10_seoManager_contextType) => {
    ...
    if (!contextPrompts[paraContextType].stages[contextTypeStage].value) {
      handleContextTypeStageChange(EProMode_v3_10_seoManager_contextTypeStage.DEFAULT);
    }
  ...
  const handleContextTypeStageChange = (paraContextTypeStage: EProMode_v3_10_seoManager_contextTypeStage) => {
              ...
              options={defaultContextTypeStagesForSelect
                .map((item) => {
                  return {
                    ...
                    value: item,
                    disabled:
                      contextPrompts[contextType].stages[item as EProMode_v3_10_seoManager_contextTypeStage].disable,
                  };
                })
          ...
          <div className="column" style={{ display: 'flex', alignItems: 'center' }}>
            ...
            <Select
              ...
              options={defaultContextTypesForSelect
                .map((item) => {
                  return {
                    label: contextPrompts[item as EProMode_v3_10_seoManager_contextType].name,
                    value: item,
                    disabled: contextPrompts[item as EProMode_v3_10_seoManager_contextType].disable,
                  };
                })
                .filter((item) => !item.disabled || item.label)}
            />
