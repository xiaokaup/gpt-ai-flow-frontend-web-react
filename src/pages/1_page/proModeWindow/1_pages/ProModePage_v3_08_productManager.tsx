...
export const ProModePage_v3_08_productManager = (props: IProModePage_copyWriting_input) => {
  ...
  const handleContextTypeChange = (paraContextType: EProMode_v3_08_productManager_contextType) => {
    ...
    if (!contextPrompts[paraContextType].stages[contextTypeStage].value) {
      handleContextTypeStageChange(EProMode_v3_08_productManager_contextTypeStage.PRODUCT_MANAGER_DEFAULT);
    }
              ...
              options={defaultContextTypeStagesForSelect
                .map((item) => {
                  return {
                    ...
                    value: item,
                    disabled:
                      contextPrompts[contextType].stages[item as EProMode_v3_08_productManager_contextTypeStage]
                        .disable,
                  };
                })
              ...
              options={defaultContextTypesForSelect
                .map((item) => {
                  return {
                    ...
                    value: item,
                    disabled: contextPrompts[item as EProMode_v3_08_productManager_contextType].disable,
                  };
                })
                .filter((item) => !item.disabled || item.label)}
            />
