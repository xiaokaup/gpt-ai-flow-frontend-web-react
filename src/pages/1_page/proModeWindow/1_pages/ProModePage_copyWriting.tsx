...
export const ProModePage_copyWriting = (props: IProModePage_copyWriting_input) => {
  const { PROMODE_DATA, DEFAULT_CONTEXT_TYPE, defaultContextTypesForSelect } = props;

  const proModeData = PROMODE_DATA as IProMode_v2_oneProMode<EProMode_v2_copyWritingManager_contextType>;
  const defaultContextType = DEFAULT_CONTEXT_TYPE as EProMode_v2_copyWritingManager_contextType;
  ...
  const [contextType, setContextType] = useState<EProMode_v2_copyWritingManager_contextType>(defaultContextType);
  ...
  const handleContextTypeChange = (paraContextPromptType: EProMode_v2_copyWritingManager_contextType) => {
        ...
        <div className="column" style={{ display: 'flex', alignItems: 'center' }}>
          ...
          <Select
            ...
            options={defaultContextTypesForSelect.map((item) => {
              return {
                label: contextPrompts[item as EProMode_v2_copyWritingManager_contextType].name,
                value: item,
              };
            })}
          />{' '}
