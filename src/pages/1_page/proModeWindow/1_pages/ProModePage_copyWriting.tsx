...
interface IProModePage_copyWriting_input {
  ...
  defaultContextType: EProMode_v2_copyWriting_contextType;
  defaultContextTypesForSelect: EProMode_v2_copyWriting_contextType[];
}
...
export const ProModePage_copyWriting = (props: IProModePage_copyWriting_input) => {
  ...
  const [contextType, setContextType] = useState<EProMode_v2_copyWriting_contextType>(defaultContextType);
  ...
  const handleContextTypeChange = (paraContextPromptType: EProMode_v2_copyWriting_contextType) => {
