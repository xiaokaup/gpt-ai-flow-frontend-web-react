...
interface IProModePage_copyWriting_input {
  ...
  defaultContextPromptType: EProMode_v2_ai_contextType;
...
export const ProModePage_ai = (props: IProModePage_copyWriting_input) => {
  ...
  const [contextPromptType, setContextPromptType] = useState<EProMode_v2_ai_contextType>(defaultContextPromptType);
