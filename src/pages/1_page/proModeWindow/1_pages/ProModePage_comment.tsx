...
import { EProMode_v2_commentManager_contextType } from '../../../../gpt-ai-flow-common/interface-backend/IProMode_v2/IProMode_v2_5_commentManager';
...
export const ProModePage_comment = (props: IProModePage_comment_input) => {
  ...
  const proModeData = PROMODE_DATA as IProMode_v2_oneProMode<EProMode_v2_commentManager_contextType>;
  const defaultContextType = DEFAULT_CONTEXT_TYPE as EProMode_v2_commentManager_contextType;
  ...
  const [contextType, setContextType] = useState<EProMode_v2_commentManager_contextType>(defaultContextType);
  ...
  const handleContextTypeChange = (paraContextPromptType: EProMode_v2_commentManager_contextType) => {
        ...
        <div className="column" style={{ display: 'flex', alignItems: 'center' }}>
          ...
          <Select
            ...
            options={defaultContextTypesForSelect.map((item) => {
              return {
                label: contextPrompts[item as EProMode_v2_commentManager_contextType].name,
                value: item,
              };
            })}
          />{' '}
