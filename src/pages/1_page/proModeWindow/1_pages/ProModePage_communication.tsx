...
interface IProModePage_communication_input {
  ...
  defaultContextType: EProMode_v2_communication_contextType;
...
export const ProModePage_communication = (props: IProModePage_communication_input) => {
  ...
  const [contextType, setContextType] = useState<EProMode_v2_communication_contextType>(defaultContextType);
  ...
  const handleContextTypeChange = (paraContextPromptType: EProMode_v2_communication_contextType) => {
