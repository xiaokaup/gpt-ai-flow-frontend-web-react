...
interface InstructionInputColumn_v4_OutputIndicatorSelect_input {
...
export const InstructionInputColumn_v4_OutputIndicatorSelect = (
  props: InstructionInputColumn_v4_OutputIndicatorSelect_input
) => {
  const {
    t,
    index,
