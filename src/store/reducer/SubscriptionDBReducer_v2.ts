...
const initialState: ISubscriptionDB_v2 = ISubscriptionDB_v2File.ISubscriptionDB_v2_default;

export const subscriptionDBReducer_v2 = (state: ISubscriptionDB_v2 = initialState, action: IAction) => {
